...
if (isset($_GET['clear_cart']) && $_GET['clear_cart'] == 'true') {
    unset($_SESSION['cart']); var_dump($_SESSION['cart']);
}
...
<head>
    ...
    <link rel="stylesheet" href="satu.css?v=1.20">
...
<body>
    ...
    <?php else: ?>
        <!-- Jika belum login, tampilkan tombol login/registrasi -->
        <form action="login.php" method="get" class="login-form" style="margin-top: 10px;">
            ...
            <?php if ($resultSepatu->num_rows > 0): ?>
                <?php while ($sepatu = $resultSepatu->fetch_assoc()): ?>
                    <div class="namasepatu-card">
                        ...
                        <img src="<?php echo htmlspecialchars($sepatu['images']); ?>" alt="<?php echo htmlspecialchars($sepatu['Nama']); ?>"><br><br>
                ...
                .then(data => {
                    ...
                    if (data.length > 0) {
                        ...
                        <div class="namasepatu-card">
                            ...
                            <img src="${namasepatu.images}" alt="${namasepatu.Nama}"><br><br>
